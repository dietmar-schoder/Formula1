...
public class GetConstructors(
    ...
    IRequestHandler<GetConstructors.Query, ConstructorsPaginatedDto>
{
    public record Query(int PageNumber, int PageSize) : IRequest<ConstructorsPaginatedDto> { }

    public async Task<ConstructorsPaginatedDto> Handle(Query query, CancellationToken cancellationToken)
    {
        Log();
        ...
        return new ConstructorsPaginatedDto(
